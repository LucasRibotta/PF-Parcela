...
const DetailSection = ({ property }) => {
  ...
  return (
    <>
      <img
        src= "https://casolutions.cl/img/entrada.jpg"
        alt= "parcela"
      ...
      <div className=" rounded-3xl border-solid border-spacing-0 w-[100%] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1280px] 2xl:w-[1536px] m-auto  relative overflow-hidden bg-white bg-opacity-30 border-transparent">
        ...
        <div className="mt-[350px] w-[100%] sm:w-[100%] p-8  rounded-br-2xl text-white mb-20 mt-[350px] lg:mt-0">
          <h3 className="font-bold text-black mb-8">Caracteristicas:</h3>

          <div className="flex [&>div]:w-[98%] text-gray-950 ">
        ...
        <div className="mt-[350px] w-[55px] h-[100px]">
          <Slider />
        </div>


        <div className="object-cover left-0 w-full h-[250px]">
          <LocationMaps location="-41.343408464426496, -73.01498748600119" />
        </div>
