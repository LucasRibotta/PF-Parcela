...
function Card({ name, precio, superficie }: CardProps) {
  ...
  return (
    <div className="flex-1 justify-center max-w-full text-white overflow-hidden shadow p-4 rounded-md border-solid border-5 border-black-500 transform hover:scale-105 transition duration-300 ease-in-out relative">
