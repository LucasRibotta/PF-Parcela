...
export default function AdminDash() {
  ...
  return (
    <PrivateRoute>
      <div className="pt-[6.8rem] flex bg-gray-800">
        <div className="flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
          <a className="flex items-center w-full px-3 mt-3" href="#">
            ...
            <span className="ml-2 text-sm font-bold">Parcelas</span>
          </a>
        ...
        <div className="flex flex-col flex-1 p-4  bg-gray-800">
          ...
          <div className="grid grid-cols-3 mt-6 ">
            {parcelas && parcelas.map(el => {
              if (el.deleted === false) {
                return <div className=" w-full flex " key={el._id}><Card name={el.name} id={el._id} /></div>
              }
            })}
